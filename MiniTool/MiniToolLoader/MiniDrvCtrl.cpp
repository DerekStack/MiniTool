...
//----------------------------------------------------------------------------------//
BOOL MiniDrvCtrl::IoControl(PCHAR SymbolicNames,
...
DWORD MiniDrvCtrl::CTL_CODE_GEN(DWORD lngFunction)
{
